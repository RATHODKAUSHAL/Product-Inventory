        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-gray-900">Product Inventory System</span>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">support@inventory.com</span>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">123 Inventory St, Suite 100</span>
              </li>
            </ul>
          </div>
        </div>
